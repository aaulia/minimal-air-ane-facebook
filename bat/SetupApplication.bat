...
:: Android packaging
set AND_CERT_NAME="MinimalAirFacebook"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\MinimalAirFacebook.p12
...
set IOS_PROVISION=cert\MinimalAirFacebook.mobileprovision
...
set APP_ID=com.minimal.AirFacebook

:: Output packages
set DIST_PATH=dist
set DIST_NAME=MinimalAirFacebook

:: Debugging using a custom IP
set DEBUG_IP=192.168.2.127
